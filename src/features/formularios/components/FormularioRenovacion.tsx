              ...
              <div className="grid md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto mb-16">
                ...
                >
                  <div className="text-center mb-6">
                    <div className="text-dk-red mb-4 flex justify-center">
                      {(() => {
                        const Icon = iconMap[PLANES_INFO.full.icon];
                ...
                >
                  ...
                  <div className="text-center mb-6 mt-4">
                    <div className="text-dk-red mb-4 flex justify-center">
                      {(() => {
                        const Icon = iconMap[PLANES_INFO["6meses"].icon];
                        return Icon ? <Icon className="w-12 h-12" /> : null;
                      })()}
                    </div>
                ...
                >
                  <div className="text-center mb-6">
                    <div className="text-emerald-500 mb-4 flex justify-center">
                      {(() => {
                        const Icon = iconMap[PLANES_INFO["12meses_sin"].icon];
                        return Icon ? <Icon className="w-12 h-12" /> : null;
                      })()}
                    </div>
              ...
              {mostrar1Mes && (
                <div className="mt-8 max-w-lg mx-auto">
                  <div className="relative bg-gradient-to-b from-green-500/10 to-green-500/5 backdrop-blur-sm border-2 border-green-500/50 rounded-2xl p-6 sm:p-8">
                    ...
                    <div className="text-center mb-6 mt-4">
                      <div className="text-dk-red mb-4"><Zap className="w-12 h-12 mx-auto" /></div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6 sm:p-8">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white/60 text-xs">Elegir fecha personalizada</p>
                    </div>
                    ...
                    return (
                      ...
                      >
                        <input
                          ...
                          disabled={isDisabled}
                          className="w-5 h-5 rounded border-neutral-600 bg-neutral-800 text-dk-red focus:ring-dk-red focus:ring-offset-0 disabled:opacity-50"
                        />
            ...
            {diasTentativos.length >= 1 && fechaFinCalculada && (
              <div className="p-6 bg-[#0A0A0A] border border-dk-red/30 mb-6">
          ...
          {/* Resumen */}
          <div >
            <h3 className="text-white text-lg font-bold font-heading tracking-wider uppercase mb-4">Resumen de tu Renovación</h3>
