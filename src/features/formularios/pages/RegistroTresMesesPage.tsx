...
export default function RegistroTresMesesPage() {
    ...
    return (
        <div className="min-h-screen bg-dk-black text-dk-white">
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                <div className="mb-8">
                    <Badge variant="primary" className="mb-3">MÁS POPULAR</Badge>
                    <h1 className="font-heading text-3xl sm:text-4xl text-dk-white tracking-wider mb-2">PROGRAMA 3 MESES FULL</h1>
                    <p className="font-body text-lg text-dk-gray-400">Nuestro programa más popular con beneficios completos</p>
                </div>
                ...
                <div className="bg-dk-gray-900 border border-dk-red/30 rounded-sm p-6 sm:p-8 mb-8">
                    ...
                    <ul className="space-y-3 text-dk-gray-200 font-body">
                        {['24 clases (2x/semana)', 'Uniforme incluido', 'Clases recuperables', '1 Congelamiento', '1 Graduación', '2 Certificados'].map(t => (
                    ...
                    <div className="mt-6 pt-6 border-t border-dk-gray-800">
                        <span className="font-heading text-4xl text-dk-white">S/869</span>
                    </div>
                </div>
            ...
            <FormularioMatricula isOpen={isFormOpen} onClose={() => { setIsFormOpen(false); navigate('/'); }} programa="full" onSuccess={() => { }} />
        </div>
    );
}
